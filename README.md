...
<ul><b><em>The application provides:</em></b>

<li><b>Admin Dashboard</b> → Manage companies, students, job postings, and placement drives.</li>

<li><b>Company Dashboard</b> → Post jobs, review applications, shortlist candidates, and update statuses.</li>
<li><b>Student Dashboard</b> → Register, upload resumes, search jobs, apply, and track application status.</li>
<li><b>Placement Tracking</b> → Maintain complete history of applications and placement outcomes.</li>
